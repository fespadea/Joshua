...
pageNum++;
tutorialPages[pageNum] = "In practice mode only, taunt can be cancelled for the sake of this tutorial.";
pageNum++;
tutorialPages[pageNum] = "You can go back a page with left+taunt and right a page with right+taunt.";
pageNum++;
