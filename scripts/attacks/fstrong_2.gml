...
set_window_value(AT_FSTRONG_2, 1, AG_WINDOW_TYPE, 9);
...
set_hitbox_value(AT_FSTRONG_2, 1, HG_KNOCKBACK_SCALING, .9);
set_hitbox_value(AT_FSTRONG_2, 1, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_FSTRONG_2, 1, HG_HITPAUSE_SCALING, .9);
