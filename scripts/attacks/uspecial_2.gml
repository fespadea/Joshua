...
set_window_value(AT_USPECIAL_2, 3, AG_WINDOW_VSPEED, -7);
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_KNOCKBACK_SCALING, .8);
set_hitbox_value(AT_USPECIAL_2, 2, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_USPECIAL_2, 2, HG_HITPAUSE_SCALING, .8);
