...
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 113);
set_hitbox_value(AT_FSTRONG, 1, HG_HEIGHT, 41);
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, 198);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_X, 133);
...
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT, 159);
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, asset_get("sfx_may_whip2"));
