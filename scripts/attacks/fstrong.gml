...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, strongHitHfx);
...
set_hitbox_value(AT_FSTRONG, 3, HG_VISUAL_EFFECT, strongHitHfx);
...
set_hitbox_value(AT_FSTRONG, 4, HG_WIDTH, 15);
...
set_hitbox_value(AT_FSTRONG, 4, HG_VISUAL_EFFECT, 159);
set_hitbox_value(AT_FSTRONG, 4, HG_HIT_PARTICLE_NUM, 1);
set_hitbox_value(AT_FSTRONG, 4, HG_HIT_SFX, asset_get("sfx_may_whip2"));
set_hitbox_value(AT_FSTRONG, 4, HG_PROJECTILE_SPRITE, sprite_get("empty"));
