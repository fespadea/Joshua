...
set_window_value(AT_FSPECIAL_2, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, .45);
set_window_value(AT_FSPECIAL_2, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, ground_friction);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HITBOX_X, 21);
