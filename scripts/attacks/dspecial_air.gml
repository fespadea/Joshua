...
set_hitbox_value(AT_DSPECIAL_AIR, 1, HG_VISUAL_EFFECT, 141);
...
set_hitbox_value(AT_DSPECIAL_AIR, 2, HG_WIDTH, 108);
set_hitbox_value(AT_DSPECIAL_AIR, 2, HG_HEIGHT, 81);
...
set_hitbox_value(AT_DSPECIAL_AIR, 3, HG_LIFETIME, 18);
set_hitbox_value(AT_DSPECIAL_AIR, 3, HG_HITBOX_X, 2);
set_hitbox_value(AT_DSPECIAL_AIR, 3, HG_HITBOX_Y, -24);
set_hitbox_value(AT_DSPECIAL_AIR, 3, HG_WIDTH, 70);
set_hitbox_value(AT_DSPECIAL_AIR, 3, HG_HEIGHT, 63);
set_hitbox_value(AT_DSPECIAL_AIR, 3, HG_PRIORITY, 1);
set_hitbox_value(AT_DSPECIAL_AIR, 3, HG_DAMAGE, 10);
set_hitbox_value(AT_DSPECIAL_AIR, 3, HG_ANGLE_FLIPPER, 8);
...
set_hitbox_value(AT_DSPECIAL_AIR, 4, HG_LIFETIME, 9);
