sprite_change_offset("idle", 13, 63);
sprite_change_offset("hurtbox", 13, 63);
sprite_change_offset("hurt", 32, 62);
sprite_change_offset("crouch", 13, 59);
sprite_change_offset("crouchbox", 13, 59);
sprite_change_offset("walk", 13, 65);
...
sprite_change_offset("jab", 13, 63);
sprite_change_offset("dattack", 64, 94);
sprite_change_offset("ftilt", 32, 62);
sprite_change_offset("dtilt", 15, 49);
sprite_change_offset("utilt", 17, 79);
...
sprite_change_offset("batit", 8, 49);