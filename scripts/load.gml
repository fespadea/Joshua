...
sprite_change_offset("roll_forward", 43, 74);
sprite_change_offset("roll_backward", 26, 74);
...
sprite_change_offset("fspecial", 40, 70);
sprite_change_offset("fspecial_2", 32, 72);
