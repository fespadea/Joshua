...
if(hitstop == 0){
    ...
    switch(state) {
        ...
        case 8: // exploding attack
            ...
            if(window == 0){
                if(window_timer == window0Length){ // WARN: Possible repetition during hitpause. Consider using window_time_is(frame) https://rivalslib.com/assistant/function_library/attacks/window_time_is.html
                    changeWindow(1);
                }
                checkForNudge();
            ...
            if(window == 1){
                if(window_timer == window1Length){ // WARN: Possible repetition during hitpause. Consider using window_time_is(frame) https://rivalslib.com/assistant/function_library/attacks/window_time_is.html
            ...
            if(window == 2){
                if(window_timer == window2Length){ // WARN: Possible repetition during hitpause. Consider using window_time_is(frame) https://rivalslib.com/assistant/function_library/attacks/window_time_is.html
                    changeWindow(3);
                }
                checkForNudge();
                image_index = 4;
        ...
        case 10: //fstrong
            ...
            if(window == 0){
                if(window_timer >= window0Length){
                    if(window_timer % 10 == 0){ // WARN: Possible repetition during hitpause. Consider using window_time_is_div(frame) https://rivalslib.com/assistant/function_library/attacks/window_time_is_div.html
                        sprite_index = sprite[10];
                        image_index = 2;
                ...
                image_index = 4;
                if(window_timer == window2Length) changeState(0); // WARN: Possible repetition during hitpause. Consider using window_time_is(frame) https://rivalslib.com/assistant/function_library/attacks/window_time_is.html
            } 
            window_timer++;
            break;
        case 11: //ustrong
