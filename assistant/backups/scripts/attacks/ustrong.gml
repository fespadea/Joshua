...
set_hitbox_value(AT_USTRONG, 1, HG_HEIGHT, 123);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, strongHitHfx);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, strongHitHfx);
